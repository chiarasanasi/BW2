              ...
              <div class="d-flex justify-content-between">
                <div class="col-6 col-md-6 mb-2 mb-md-0">
                  <div class="d-flex w-100">
                    ...
                    <button onclick="history.back()" class="btn btn-light me-2 bg-transparent border-0 text-light-emphasis">
                      <svg
                    ...
                    <button onclick="history.forward()" class="btn me-2 bg-transparent border-0 text-light-emphasis">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="25"
                        height="25"
